...
public final class SecondPartTasks {
    ...
    public static double piDividedBy4() {
        class Point {
            ...
            public boolean isInUnitDisk() {
                return x * x + y * y <= 1;
            }
        }

        int POINT_NUMBER = 1000000;
        return (double) Stream.generate(Point::new).limit(POINT_NUMBER).filter(Point::isInUnitDisk).count() / POINT_NUMBER;
    }
