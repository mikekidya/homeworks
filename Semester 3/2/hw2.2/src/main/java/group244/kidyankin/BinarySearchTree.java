...
/**
 * Class realizing Collection as Binary Search Tree.
 *
...
public class BinarySearchTree<T extends Comparable<T>> implements Collection<T>, Iterable<T> {
     ...
     * @param a the array into which the elements of this collection are to be store
     * @return an array containing all of the elements in this collection
     */
    @Override
    @SuppressWarnings("unchecked")
    ...
    /**
     * Class realizing BST Nodes – elements BST technically contains.
    ...
    private class Node {
        ...
        private void changeNode(Node newNode) {
            ...
            if (newNode.equals(newNode.parent.leftChild)) {
                newNode.parent.leftChild = newNode.leftChild;
            } else {
